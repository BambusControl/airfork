                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="firstname" id="firstname" class="form-control" value="<?= empty($data['firstname']) ? "" : $data['firstname'] ?>" pattern="([A-Z])[\w]+" title="Meno musí začínať veľkým písmenom" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="lastname" id="lastname" class="form-control" value="<?= empty($data['lastname']) ? "" : $data['lastname'] ?>" pattern="([A-Z])[\w]+" title="Priezvisko musí začínať veľkým písmenom" required>
                        </div>
                    </div>
                ...
                <div class="form-row">
                            ...
                            <div class="col-form-label" id="gender">
                                ...
                                <div class="form-check-inline disabled">
                                    <label class="form-check-label hoverable">
                                        <input type="radio" class="form-check-input" name="gender" value="other" disabled <?= @$data['gender'] == 'other' ? "checked" : "" ?> required>Neznaboh
                    ...
                    <div class="col-sm">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="username" id="username" class="form-control <?= empty($data['error']['username']) ? '' : 'is-invalid'?>" aria-describedby="username-warning" value="<?= empty($data['username']) ? "" : $data['username'] ?>" required>
